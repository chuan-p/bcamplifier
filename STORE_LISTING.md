...
`Bandcamp Feed Enhancer improves the Bandcamp fan feed with richer release metadata, readable inline tracklists, persistent playback controls, wishlist shortcuts, and quicker access to Bandcamp's native purchase flow. It is built for people who browse their feed often and want more context without opening every release in a separate tab.`
