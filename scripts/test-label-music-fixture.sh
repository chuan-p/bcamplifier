...
checks = {
    ...
    'data-bcampx-label-feed-count="2"': "all release links were collected",
    ...
    'data-bcampx-label-feed-card-count="2"': "featured releases were deduplicated",
    ...
    'data-bcampx-enhanced-count="2"': "synthetic cards reused feed enhancement",
