...
checks = {
    ...
    'data-bcampx-label-release-tags="tags: synth-pop, fixture-waveJan 2, 2024 · Shanghai"': "label music cards rendered release tags and date",
    'data-bcampx-label-release-tags-in-col1="false"': "label music tags rendered in the full-width metadata row",
